---
description: "Use when working on pointages data flow, Dexie queries, Supabase sync, or history/home views. Enforce on-demand loading, date-range filtering, pagination, and cache invalidation rules."
...
- Keep Dexie as the local cache and hydrate from Supabase on demand.
...
- Real-time cloud events that update Dexie must also invalidate cache.
